    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="#" class="brand-link">
                ...
                <span class="brand-text font-weight-light">BAGIAN KEUANGAN</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item">
                            <a href="<?= base_url('BagKeuangan/HargaProduk') ?>" class="nav-link <?php if ($this->uri->segment(1) == 'BagKeuangan' && $this->uri->segment(2) == 'HargaProduk') {
                                                                                                        echo 'active';
                                                                                                    }  ?>">
