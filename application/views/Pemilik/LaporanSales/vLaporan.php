            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Laporan Transaksi Sales</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <?php
                            echo form_open('Pemilik/cLaporanSales/lap_harian_sales') ?>
                            <div class="row">
                                <div class="col-sm-4">
                ...
                <div class="col-md-4">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <?php
                            echo form_open('Pemilik/cLaporanSales/lap_bulanan_sales') ?>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Bulan</label>
                ...
                <div class="col-md-4">
                    <div class="card card-info">
                        ...
                        <div class="card-body">
                            <?php
                            echo form_open('Pemilik/cLaporanSales/lap_tahunan_sales') ?>
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Tahun</label>
