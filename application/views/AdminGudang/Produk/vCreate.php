            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Create New Produk</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
            ...
            <div class="col-md-12">
                <div class="card card-outline card-info">
                    ...
                    <div class="card-body pad">
                        <?php echo form_open_multipart('Admin/cKelolaProduk/create'); ?>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="produk" class="form-control" id="exampleInputPassword1" placeholder="Masukkan Nama Produk">
                            ...
                            <div class="input-group">
                                <div class="custom-file">
                                    <input type="file" name="gambar" class="form-control" id="exampleInputFile" required>
                                </div>
                            </div>
                            <div class="input-group">
