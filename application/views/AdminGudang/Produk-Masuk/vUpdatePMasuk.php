                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="produk" id="produk" required>
                                    ...
                                    ?>
                                        <option value="<?= $value->id_produk ?>" <?php if ($value->id_produk == $produk_masuk->id_produk) {
                                                                                        echo 'selected';
                                                                                    }
                            ...
                            <div class="form-group">
                                ...
                                <p>Size : <?= $produk_masuk->nama_size ?></p>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="date" value="<?= $produk_masuk->tgl_masuk ?>" name="tgl" class="form-control" id="exampleInputFile" required>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-file">
                                        <input type="number" value="<?= $produk_masuk->qty_masuk ?>" name="qty" class="form-control" id="exampleInputFile" required>
                                    </div>
                                </div>
